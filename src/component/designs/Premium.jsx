    ...
    <div className="bg-white w-[330px] md:w-[400px] lg:w-[250px] xl:[280px]  2xl:w-[400px] h-[330px] mx-auto shadow-2xl mt-6 rounded-xl pl-4">
      <div>
        ...
        <div className="relative">
          ...
          <img
            className="absolute w-[50px] rotate-12  left-0  -top-2 right-0 "
            src={require("../assets/115-1154076_clip-art-for-free-download-clip-art-red-removebg-preview.png")}
            alt=""
          />
        </div>
        <p className="font-meduim text-2xl">$ 9.99/mo</p>
        <div className="mt-2">
          <button className="bg-blue-200 hover:bg-blue-500 w-[150px] relative flex  gap-x-2 font-medium p-1 rounded-lg">
            Get Started
