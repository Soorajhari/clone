...
const Free = () => {
  return (
    <div className="bg-[#ffff] w-[300px] lg:w-[720px] h-[500px] lg:h-[280px] mx-auto shadow-2xl mt-6 rounded-xl pt-1 block lg:flex gap-x-5">
        <div>
        <div className="ml-10">
        <button className=" mt-8 p-0.5 rounded-3xl w-[100px] bg-[#9ADE7B] hover:bg-green-600 font-medium text-xs flex justify-center items-center">
          free forevevr
        </button>
      </div>
      ...
      <div className="ml-10 mt-6">
        <button className="bg-[#9ADE7B] hover:bg-green-600 w-[150px] relative flex  gap-x-2 font-medium p-1 rounded-lg">
          Get Started
